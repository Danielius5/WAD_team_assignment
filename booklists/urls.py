...
urlpatterns = [
    ...
    path('user/<str:username>/lists/<slug:list_slug>/<slug:book_slug>/delete', views.book_delete_from_list, name='book_delete_from_list'),
    path('user/<str:username>/lists/<slug:list_slug>/<slug:book_slug>/add', views.book_add_to_list, name='add_book'),
    path('book/<slug:book_slug>/rate', views.book_rate, name='book_rate'),
    path('search', views.search, name='search'),
    path('author/<slug:author_slug>', views.author_show, name='author_show'),
